<div class="atfp-dashboard-license">
    ...
    <p>
        <?php _e('You\'re using <strong>AutoPoly - AI Translation For Polylang (free)</strong> - no license needed. Enjoy! 😊', $text_domain); ?>
    </p>

    <div class="atfp-dashboard-upgrade-box">
        <p>
            <?php _e('To unlock more features, consider', $text_domain); ?>
            <a href="https://coolplugins.net/product/autopoly-ai-translation-for-polylang/?utm_source=atfp_plugin&utm_medium=inside&utm_campaign=get_pro&utm_content=license" target="_blank"><?php _e('upgrading to Pro', $text_domain); ?></a>.
        </p>
